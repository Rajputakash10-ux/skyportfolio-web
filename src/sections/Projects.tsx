          ...
          >
            ...
            <div className="p-6 flex flex-col flex-1">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 w-full py-2.5 rounded-xl border border-white/10 text-sm font-semibold text-[#9CA3AF] hover:text-white hover:border-[#3B82F6]/60 hover:bg-[#3B82F6]/8 transition-all duration-200 group/btn"
              >
                ...
                View on GitHub
                <svg className="group-hover/btn:translate-x-0.5 transition-transform" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M7 17L17 7M17 7H7M17 7v10"/></svg>
              </a>
            </div>
          </motion.div>
        ))}
