...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      {/* Gradient orbs — CSS animations to avoid non-composited JS animations */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="orb-blue absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-[#3B82F6] rounded-full blur-[140px]" />
        <div className="orb-purple absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-[#8B5CF6] rounded-full blur-[140px]" />
        <div className="orb-pink absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-[#EC4899] rounded-full blur-[120px]" />
      </div>
