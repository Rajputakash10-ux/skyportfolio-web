    ...
    <>
      ...
      <m.div {...fadeUp(0.28)} className="flex flex-wrap items-center justify-center gap-3 mb-10">
        <a
          ...
          className="px-6 py-3 rounded-xl font-semibold text-white bg-gradient-to-r from-[#3B82F6] to-[#8B5CF6] hover:from-[#2563EB] hover:to-[#7C3AED] hover:scale-105 transition-[transform,opacity] duration-200 shadow-lg shadow-blue-500/20 animate-pulse-glow focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
        >
          Hire Me →
        </a>
        <a
        ...
        <a
          ...
          className="px-4 py-3 rounded-xl font-semibold glass border border-white/10 hover:border-white/25 hover:scale-105 transition-[transform,opacity] duration-200 flex items-center gap-2 text-[#9CA3AF] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#3B82F6]"
        >
        ...
        <a
          ...
          className="px-4 py-3 rounded-xl font-semibold glass border border-white/10 hover:border-[#3B82F6]/50 hover:scale-105 transition-[transform,opacity] duration-200 flex items-center gap-2 text-[#9CA3AF] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#3B82F6]"
        >
