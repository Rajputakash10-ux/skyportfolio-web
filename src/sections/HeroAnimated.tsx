...
export default function HeroAnimated() {
  return (
    <>
      {/* Status badge */}
      <m.div {...fadeUp(0.05)} className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full glass border border-[#3B82F6]/25 text-sm text-[#9CA3AF] mb-8 shimmer">
      ...
      {/* Typing role */}
      <m.div {...fadeUp(0.15)} className="text-xl sm:text-2xl lg:text-3xl font-sora font-semibold text-[#9CA3AF] mb-5 h-10 flex items-center justify-center gap-2">
      ...
      {/* Description */}
      <m.p {...fadeUp(0.25)} className="text-[#9CA3AF] text-base sm:text-lg max-w-2xl mx-auto mb-10 leading-relaxed">
      ...
      {/* CTA Buttons */}
      <m.div {...fadeUp(0.35)} className="flex flex-wrap items-center justify-center gap-3 mb-16">
        <a
          href="/resume.pdf"
          download
