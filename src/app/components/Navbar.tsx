    ...
    <>
      ...
      >
        <nav className="container-max flex items-center justify-between px-6 md:px-10 lg:px-16 py-4">
          ...
          <a
            href="#"
            className="text-base font-bold tracking-tight gradient-text focus-ring rounded"
          ...
          <a
            ...
            download
            className="hidden md:flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg bg-gradient-to-r from-indigo-600 to-cyan-500 text-white hover:opacity-85 hover:scale-105 transition-all duration-200 focus-ring shadow-glow-sm"
          >
        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 z-50 w-72 bg-bg-secondary border-l border-[var(--border)] flex flex-col md:hidden"
            >
              ...
              <div className="px-4 pb-8">
                <a
                  ...
                  download
                  onClick={() => setOpen(false)}
                  className="flex items-center justify-center gap-2 w-full px-4 py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-cyan-500 text-white text-sm font-medium focus-ring"
                >
